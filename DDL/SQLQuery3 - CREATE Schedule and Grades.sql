...
--CREATE TABLE Grades
--(
--student INT CONSTRAINT FK_Grades_Studennts FOREIGN KEY REFERENCES Students(student_id),
...
--CREATE TABLE Exams
--(
--student INT CONSTRAINT FK_Exams_Studennts FOREIGN KEY REFERENCES Students(student_id),
